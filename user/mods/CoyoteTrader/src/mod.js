...
class Coyote {
    ...
    postDBLoad(container) {
        ...
        this.fluentAssortCreator.createComplexAssortItem(this.traderHelper.createGlock())
            ...
            .addMoneyCost(Money_1.Money.DOLLARS, 250)
            .addBuyRestriction(3)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_GSIGFLARE_ID)
            .addStackCount(100)
            .addBuyRestriction(10)
            .addMoneyCost(Money_1.Money.DOLLARS, 100)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_WIRES_ID)
            .addStackCount(20)
            .addBuyRestriction(10)
            .addMoneyCost(Money_1.Money.DOLLARS, 125)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_THERM_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 280)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_TNT_ID)
            .addStackCount(10)
            .addBuyRestriction(3)
            .addMoneyCost(Money_1.Money.DOLLARS, 200)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_LEATHER_ID)
            .addStackCount(10)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 190)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_ROUND_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 160)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_PLIERS_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 135)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_KITE_ID)
            .addStackCount(20)
            .addBuyRestriction(3)
            .addMoneyCost(Money_1.Money.DOLLARS, 215)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_BLEACH_ID)
            .addStackCount(30)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 90)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_MARKER_ID)
            .addUnlimitedStackCount()
            .addBuyRestriction(10)
            .addMoneyCost(Money_1.Money.DOLLARS, 130)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_SMOKEBAL_ID)
            .addStackCount(30)
            .addBuyRestriction(4)
            .addMoneyCost(Money_1.Money.DOLLARS, 240)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_AVIATOR_ID)
            .addStackCount(30)
            .addBuyRestriction(4)
            .addMoneyCost(Money_1.Money.DOLLARS, 110)
            .addLoyaltyLevel(1)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_FUZE_ID)
            .addStackCount(30)
            .addBuyRestriction(4)
            .addMoneyCost(Money_1.Money.DOLLARS, 205)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_HAWK_ID)
            .addStackCount(25)
            .addBuyRestriction(3)
            .addMoneyCost(Money_1.Money.DOLLARS, 180)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_EAGLE_ID)
            .addStackCount(25)
            .addBuyRestriction(3)
            .addMoneyCost(Money_1.Money.DOLLARS, 430)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_EFUEL_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 1010)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_KLEAN_ID)
            .addStackCount(20)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 185)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_RGD5_ID)
            .addStackCount(50)
            .addBuyRestriction(5)
            .addMoneyCost(Money_1.Money.DOLLARS, 150)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_NADECASE_ID)
            .addStackCount(5)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 2100)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_MUSTACHE_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 140)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_HOLODILNICK_ID)
            .addStackCount(5)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 2220)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_TRIZIP_ID)
            .addStackCount(5)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 450)
            .addLoyaltyLevel(2)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_THICCCASE_ID)
            .addStackCount(2)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 96000)
            .addLoyaltyLevel(3)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_MONEYCASE_ID)
            .addStackCount(4)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 2700)
            .addLoyaltyLevel(3)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_JUNKBOX_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 7000)
            .addLoyaltyLevel(3)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_GAC1_ID)
            .addStackCount(8)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 365)
            .addLoyaltyLevel(3)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_TROOPER35_ID)
            .addStackCount(5)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 410)
            .addLoyaltyLevel(3)
            .export(tables.traders[baseJson._id]);
        //LLevel4
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_WEPCASE_ID)
            .addStackCount(5)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 24000)
            .addLoyaltyLevel(4)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_KEYCARDHOLDER_ID)
            .addStackCount(5)
            .addBuyRestriction(1)
            .addMoneyCost(Money_1.Money.DOLLARS, 1650)
            .addLoyaltyLevel(4)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_KEYTOOL_ID)
            .addStackCount(10)
            .addBuyRestriction(2)
            .addMoneyCost(Money_1.Money.DOLLARS, 3300)
            .addLoyaltyLevel(4)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_338MAGNUMAP_ID)
            ...
            .addMoneyCost(Money_1.Money.DOLLARS, 15)
            .addLoyaltyLevel(4)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_68HYBRID_ID)
            ...
            .addMoneyCost(Money_1.Money.DOLLARS, 7)
            .addLoyaltyLevel(4)
            .export(tables.traders[baseJson._id]);
        ...
        this.fluentAssortCreator.createSingleAssortItem(c_300AP_ID)
            .addStackCount(160)
            .addBuyRestriction(80)
            .addMoneyCost(Money_1.Money.DOLLARS, 6)
            .addLoyaltyLevel(4)
            .export(tables.traders[baseJson._id]);
        ...
        this.logger.log("********Coyote has entered the zone!********", LogTextColor_1.LogTextColor.GREEN);
    }
}
