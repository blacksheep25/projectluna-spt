...
class TraderPics implements IPreAkiLoadMod, IPostAkiLoadMod
{
    ...
    public postAkiLoad(container: DependencyContainer) {
        ...
        const { extension, updateAllTraders, updatePrapor, updateTherapist, updateFence, updateSkier, updatePeacekeeper, updateMechanic, updateRagman, updateJaeger, updateLightKeeper, AIOTrader, AKGuy, AnastasiaSvetlana, ARSHoppe, Bootlegger, DRIP, GearGal, GoblinKing, Gunsmith, IProject, KatarinaBlack, KeyMaster, MFACShop, Priscilu, Questor, TheBroker, PAINTERSHOP } = require('./config.json');
