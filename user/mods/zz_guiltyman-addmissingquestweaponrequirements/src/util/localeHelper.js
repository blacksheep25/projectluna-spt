...
let LocaleHelper = class LocaleHelper {
    db;
    locale;
    constructor(db) {
        this.db = db;
...
exports.LocaleHelper = LocaleHelper = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof DatabaseServer_1.DatabaseServer !== "undefined" && DatabaseServer_1.DatabaseServer) === "function" ? _a : Object])
], LocaleHelper);
