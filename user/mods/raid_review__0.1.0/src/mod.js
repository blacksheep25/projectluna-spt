...
class Mod {
        ...
        staticRouterModService.registerStaticRouter('GetPlayerInfo', [
            {
                ...
                action: (_url, __info, sessionId, output) => {
    ...
    async postAkiLoad(container) {
        ...
        this.wss.on('connection', async (ws) => {
            ...
            ws.on('message', (data) => (0, packetHandler_1.messagePacketHandler)(data, this.database, this.sessionManager, this.modDetector, this.logger, post_raid_processing));
        });
