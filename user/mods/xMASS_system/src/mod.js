...
class AddItems {
    ...
    postDBLoad(container) {
        ...
        for (const [mmFACID, mmFACItem] of Object.entries(this.mydb.mmfac_items)) {
            ...
            if (this.mydb.mmfac_items[mmFACID].enable)
                this.addToFilters(mmFACID, sptID);
        }
    ...
    cloneItem(itemToClone, mmFACID, sptID) {
    ...
    copyToFilters(itemClone, mmFACID, sptID, enableCompats = true, enableConflicts = true) {
        ...
        const sptIDs = [];
        for (const mmFACItem of Object.values(this.mydb.mmfac_items))
            sptIDs.push(mmFACItem.sptID);
    ...
    cloneClothing(articleToClone, mmFACID, sptID) {
    ...
    */
    addLocales(mmFACID, sptID, mmFACItem, mmFACArticle) {
