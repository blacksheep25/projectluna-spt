...
exports.generateInterpolatedFramesBezier = exports.interpolateBezier = exports.ExtractKeysAndValues = void 0;
const bezier_js_1 = require("bezier-js");
function ExtractKeysAndValues(obj) {
    function processObject(inputObj, parentKey) {
        const keys = [];
        const values = [];
...
function interpolateBezier(point1, control1, control2, point2, t) {
    const curve = new bezier_js_1.Bezier(point1.x, point1.y, point1.z, control1.x, control1.y, control1.z, control2.x, control2.y, control2.z, point2.x, point2.y, point2.z);
...
exports.generateInterpolatedFramesBezier = generateInterpolatedFramesBezier;
