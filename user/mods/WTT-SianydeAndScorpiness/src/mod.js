...
class SianydeAndScorpiness {
    Instance = new WTTInstanceManager_1.WTTInstanceManager();
    version;
    modName = "SianydeAndScorpiness";
    config;
    //#region CustomBosses
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Developers:    Gun & Parts: Sianyde  Animations: Tron  Code Framework: GroovypenguinX`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new SianydeAndScorpiness() };
