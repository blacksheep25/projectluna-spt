...
class WTTArmoryCheytac {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] "Seize The Distance"`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTArmoryCheytac() };
