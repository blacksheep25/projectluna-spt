...
async function sendStatistics(db, profileId, raidId, positions) {
    const raidData = await (0, GetRaidData_1.getRaidData)(db, profileId, raidId);
...
async function generateStatisticsPayload(raid, positions) {
    // Data points
    let players = {
        total: 0,
        usec: 0,
    ...
    const data = {
        ...
        distanceTravelled: (0, CalculateDistancesTravelled_1.calculateTotalDistance)(positions)
    };
    return data;
}
async function sendStatisticsPayload(statisticsPayload) {
    try {
